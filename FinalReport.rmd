...
In the numerical data the white race is in favor 67.75opposed 32.25, black race is in favor 47.24and opposed 52.76, the other race is in favor 61.25 and opposed 38.75 They are all different. 
...
The P Value is 7.704e-05. here we have more participant, and it is two.side.
...
The only thing that is different is white race and black race . More data makes a big difference. 

# Discussion and Conclusion


The big difference is the more data side the more data we get. when we look at the the more data the difference is very clear in regards to black and white.These two races have strong data that allows us to see how they differ from each other.

...
The big difference is the more data side the more data we get. when we look at the the more data the difference is very clear in regards to black and white.These two races have strong data that allows us to see how they differe from each other. 
